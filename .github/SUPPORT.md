# Getting help with tricordr

Thanks for using tricordr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/tricordr/issues) to make sure the 
